...
//
//public class MyTMCompUserDefine4 {
...
//                .collect(Collectors.toMap(emp -> emp.getName(), emp -> emp.getSecond()));
////да
////        а еще есть groupingBy смотри как работает
//
//        Empl empl = new Empl("z","x");
//        Emp emp = new Emp("v");
//
...
////
////
////        Map<Employee, List<Employee>> result = list.stream()
...
////        Empl em;
////        Map<Employee, String> result4  = list.stream()
////                .collect(Collectors.toMap(emp -> emp,
////
////                        list.stream()
...
//
////        List<Emp> lk = list.stream().forEach((em) -> em));//collect(Collectors.toList(em -> em));
//
////        System.out.println("== "+result.get(list.get(0)).get(0).getName());
//
//
//
